...
import { solutionsData } from "@/src/data/solutionsData";
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.garagesaarthi.com/solutions/${slug}/`,
    },
    openGraph: {
      title: data.title,
      description: data.description,
      url: `https://www.garagesaarthi.com/solutions/${slug}/`,
      type: "website",
      images: [
        {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-600 mb-8 leading-relaxed">
                Run your daily workshop activities with complete visibility. Save time on administrative entries and focus on delivering excellent service.
              </p>
            ...
            <div className="bg-gradient-to-tr from-orange-100 to-orange-50 p-8 rounded-2xl border border-orange-200/50 shadow-sm relative overflow-hidden group">
              ...
              <p className="text-orange-900/80 text-sm leading-relaxed mb-6">
                We design custom operations workflows so you don't have to struggle with general SaaS parameters that don't fit automotive repair mechanics.
              </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-600 mt-2">
                Clear answers to questions about our {data.h1.toLowerCase()}.
              </p>
            </div>
