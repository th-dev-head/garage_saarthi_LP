...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      applicationSubCategory: "Car Detailing Software",
      operatingSystem: "Android, Web",
      url: "https://www.garagesaarthi.com/solutions/car-detailing-software",
      description:
        "GarageSaarthi is a studio management software for managing car detailing jobs, customer and vehicle records, polishing and coating stock, GST billing, and WhatsApp follow-up alerts.",
      featureList: [
        "Digital Job Cards",
        "Customer Management",
        "Vehicle Management",
