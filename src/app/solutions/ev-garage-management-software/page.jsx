...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      applicationSubCategory: "EV Garage Management Software",
      operatingSystem: "Android, Web",
      url: "https://www.garagesaarthi.com/solutions/ev-garage-management-software",
      description:
        "GarageSaarthi is a workshop management software for managing EV job cards, customer records, electric vehicle databases, parts inventory, GST billing, and service reminders.",
      featureList: [
        "Digital Job Cards",
        "Customer Management",
        "Vehicle Management",
