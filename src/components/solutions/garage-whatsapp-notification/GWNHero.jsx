      ...
      <div className="mx-auto max-w-full lg:max-w-3xl w-full relative z-10 text-center flex flex-col items-center">
        <div className="flex flex-col items-center text-center max-w-3xl">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight">
            Garage WhatsApp Notification Software for Service Reminders & <GradientUnderline>Customer Follow-Ups</GradientUnderline>
          </h1>
          <p className="text-slate-300 text-sm md:text-base leading-relaxed mb-8 max-w-2xl mx-auto">
            Communicate with customers through organized WhatsApp notifications linked directly with vehicle registers, service due dates, and digital job card logs. Built specifically for workshops in India.
          </p>
