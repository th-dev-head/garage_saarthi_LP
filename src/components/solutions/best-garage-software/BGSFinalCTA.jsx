    ...
    <section className="py-20 px-4 lg:px-15 2xl:px-50 bg-slate-50 flex justify-center text-center">
      <div className="mx-auto max-w-full lg:max-w-4xl w-full space-y-6">
        ...
        <p className="text-slate-600 text-sm md:text-base leading-relaxed max-w-2xl mx-auto">
          Create a customer profile, register a vehicle, prepare a digital job sheet, deduct inventory stock, generate a GST bill, and explore your garage dashboard during the 7-day free trial.
        </p>
