            ...
            <div className="max-w-xs w-full mx-auto space-y-6">
              <div className="flex items-center gap-4 text-slate-800">
                ...
                <div className="text-left">
                  <h4 className="text-xs font-bold">Cloud Web Dashboard</h4>
                  <p className="text-[10px] text-slate-400">For Office PC, Billing & Analytics</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 text-slate-800">
                ...
                <div className="text-left">
                  ...
                  <p className="text-[10px] text-slate-400">For Bay Floor Job Cards & Inventory Checks</p>
                </div>
              </div>
            </div>
          </div>
