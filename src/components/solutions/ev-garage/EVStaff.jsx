...
export default function EVStaff() {
  return (
      ...
      <div className="mx-auto max-w-full lg:max-w-6xl 2xl:max-w-full w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {staffCards.map((item, idx) => {
            ...
            return (
              <div key={idx} className="bg-slate-50 border border-slate-200/60 rounded-3xl p-5 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between">
