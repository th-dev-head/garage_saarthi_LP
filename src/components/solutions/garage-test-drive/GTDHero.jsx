...
import { FaArrowRight, FaRoad, FaShieldAlt } from "react-icons/fa";
...
export default function GTDHero() {
  const handleTrialClick = () => {
    trackEvent("test_drive_solution_trial_cta_click", {
  ...
  const handlePricingClick = () => {
    trackEvent("test_drive_solution_pricing_click", {
      page_path: "/solutions/garage-test-drive-software/",
      cta_location: "hero",
      ...
      <div className="mx-auto max-w-full lg:max-w-5xl w-full relative z-10 text-center flex flex-col items-center">
        <div className="flex flex-col items-center text-center max-w-5xl">
          <div className="inline-flex items-center gap-2 bg-white/10 text-white/80 text-xs font-semibold px-4 py-1.5 rounded-full border border-white/20 mb-6">
            ...
            <FaRoad className="text-primary w-3.5 h-3.5" />
            Garage Test Drive Software India
          </div>
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight">
            Digital Test Drive &amp; Road Test Software for{" "}
          ...
          <p className="text-slate-300 text-sm md:text-base leading-relaxed mb-8 max-w-2xl mx-auto">
            Eliminate unauthorized vehicle joyrides, prevent fuel theft complaints, and protect your garage from scratch blame games. Log odometer kilometers, fuel gauges, 2D damage diagrams, and touchscreen driver signatures.
          </p>
