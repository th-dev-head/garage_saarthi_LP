...
export default function GTDFreeTrial() {
  const handleTrialClick = () => {
    trackEvent("test_drive_trial_cta_click", {
  ...
  const handlePricingClick = () => {
    trackEvent("test_drive_pricing_click", {
      page_path: "/solutions/garage-test-drive-software/",
      cta_location: "pricing_section",
    ...
    <section className="py-20 px-4 lg:px-15 2xl:px-50 bg-slate-50 flex justify-center">
      <div className="mx-auto max-w-full lg:max-w-6xl 2xl:max-w-full w-full text-center">
        ...
        <h2 className="text-2xl md:text-4xl font-bold text-text-dark mt-4 mb-6 leading-tight">
          Try Garage Test Drive Software{" "}
        ...
        <p className="text-slate-600 text-sm md:text-base leading-relaxed mb-8 max-w-xl mx-auto">
          Explore complete access to our digital test drive engine, 2D damage diagramming, odometer tracking, and touchscreen signatures. No credit card required.
        </p>
