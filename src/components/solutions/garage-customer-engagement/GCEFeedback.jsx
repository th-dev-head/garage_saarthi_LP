...
export default function GCEFeedback() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              ...
              Use our <strong className="text-primary capitalize">garage customer feedback software</strong> notes system to record key feedback comments directly on the customer's vehicle timeline.
            </p>
            
            <p className="text-slate-600 text-sm leading-relaxed">
              Whenever a client makes an inquiry, check previous notes for comments on service quality or custom requirements. 
              Having this context available in your <strong className="text-primary capitalize">workshop customer feedback software</strong> database helps team members avoid disputes and deliver tailored solutions.
            </p>
          </div>
