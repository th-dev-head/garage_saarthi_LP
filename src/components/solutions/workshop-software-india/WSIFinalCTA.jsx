    ...
    <section className="py-20 px-4 lg:px-15 2xl:px-50 bg-white flex justify-center text-center">
      <div className="mx-auto max-w-full lg:max-w-4xl w-full space-y-6">
        ...
        <p className="text-slate-600 text-sm md:text-base leading-relaxed max-w-2xl mx-auto">
          Join automobile workshops across India using GarageSaarthi for digital job cards, GST billing, spare parts inventory, mechanic payroll, and automated WhatsApp alerts.
        </p>
