      ...
      <div className="mx-auto max-w-full lg:max-w-6xl 2xl:max-w-full w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white border border-slate-200/80 rounded-3xl p-6 shadow-sm space-y-3">
            ...
            <h3 className="text-sm font-bold text-slate-900">Seasonal Checkup Specials</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
              Launch monsoon safety checks, summer AC service packages, or Diwali festive discount coupons for your customer database.
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-200/80 rounded-3xl p-6 shadow-sm space-y-3">
            ...
            <h3 className="text-sm font-bold text-slate-900">Service Package Discounts</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
              Bundle oil changes, wheel alignment, and foam washing into attractive discounted package rates for loyal clients.
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-200/80 rounded-3xl p-6 shadow-sm space-y-3">
            ...
            <h3 className="text-sm font-bold text-slate-900">Structured Campaign Management</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
              Track offer validity dates, active promotion codes, and response rates inside your central garage dashboard.
            </p>
          </div>
        </div>
