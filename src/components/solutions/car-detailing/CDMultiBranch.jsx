...
export default function CDMultiBranch() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 bg-white border border-slate-200/50 rounded-3xl p-6 shadow-sm space-y-4">
            <div className="flex items-center justify-between border-b border-slate-200 pb-3">
              ...
              <span className="bg-primary/10 text-primary text-[10px] font-bold px-2 py-0.5 rounded-full">2 Active</span>
            </div>
            <div className="space-y-3">
              <div className="flex justify-between items-center text-xs">
                <span className="text-slate-600 font-medium">Mumbai Studio</span>
                <span className="text-slate-800 font-bold">12 Active Cards</span>
              </div>
              <div className="flex justify-between items-center text-xs">
                <span className="text-slate-600 font-medium">Pune Studio</span>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h2 className="text-2xl md:text-4xl font-bold text-text-dark mt-4 mb-6 leading-tight">
              Manage Multiple Detailing Branches <GradientUnderline>from One Platform</GradientUnderline>
            </h2>
            <p className="text-slate-600 text-sm md:text-base leading-relaxed">
              Consolidate operations across multiple detailing studios. Monitor branch-wise collections, transfer spare chemicals or rolls between locations, and define role-based access for local managers centrally.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-slate-600 pt-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Consolidated Revenue Reports</span>
              </div>
            </div>
