...
const reportItems = [
  {
    title: "Studio Activity Reports",
    desc: "Monitor active, pending, or completed job cards dynamically. Track job durations and detailer performance indicators.",
  },
  {
  ...
  {
    title: "Inventory Chemical Valuation",
...
export default function CDDashboardReports() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h2 className="text-2xl md:text-4xl font-bold text-text-dark mt-4 mb-4 leading-tight">
              Understand Your Detailing Studio with{" "}
              <GradientUnderline>Dashboard and Reports</GradientUnderline>
            </h2>
            <p className="text-slate-600 text-sm md:text-base leading-relaxed">
              Ditch the guesswork. View clear reports on how your detailing studio is performing. Audit parts stock, see detailer collections, and view payments received in a few clicks.
            </p>
          ...
          <div className="lg:col-span-5 bg-slate-50 border border-slate-200/80 rounded-3xl p-6 md:p-8 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white border border-slate-200/40 p-4 rounded-2xl shadow-xs">
                <span className="text-[10px] text-slate-400 font-bold uppercase">Active Cars</span>
                <p className="text-lg font-bold text-slate-800 mt-1">6</p>
              </div>
              <div className="bg-white border border-slate-200/40 p-4 rounded-2xl shadow-xs">
                <span className="text-[10px] text-slate-400 font-bold uppercase">Today's Sales</span>
                <p className="text-lg font-bold text-primary mt-1">₹18,500</p>
              </div>
              <div className="bg-white border border-slate-200/40 p-4 rounded-2xl shadow-xs">
                <span className="text-[10px] text-slate-400 font-bold uppercase">CRM Leads</span>
                <p className="text-lg font-bold text-slate-800 mt-1">12</p>
              </div>
              <div className="bg-white border border-slate-200/40 p-4 rounded-2xl shadow-xs">
                <span className="text-[10px] text-slate-400 font-bold uppercase">Low Stock Alerts</span>
                <p className="text-lg font-bold text-red-600 mt-1">1</p>
              </div>
            </div>
          </div>
        </div>
