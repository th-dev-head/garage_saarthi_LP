...
const differentiators = [
  "Built specifically for automotive and detailing workshop operations",
  "Supports custom paint correction and ceramic checklists",
  ...
  "Tracks spare chemical inventory and enables retail counter sales",
...
export default function CDWhyUs() {
  return (
      ...
      <div className="mx-auto max-w-full lg:max-w-6xl 2xl:max-w-full w-full">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-2xl md:text-4xl font-bold text-text-dark mt-4 mb-6 leading-tight">
            Why Detailing Studio Owners{" "}
            <GradientUnderline>Choose GarageSaarthi</GradientUnderline>
          </h2>
          <p className="text-slate-600 text-sm md:text-base leading-relaxed">
            Auto detailing studios need software tailored to checklists, coating warranties, chemicals, and detailers. Here is why detailing studio owners choose GarageSaarthi.
          </p>
        </div>
