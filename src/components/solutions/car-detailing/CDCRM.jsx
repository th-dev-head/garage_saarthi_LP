...
const crmPoints = [
  {
    ...
    desc: "Record incoming enquiries for new PPF wrap quotes, ceramic coatings, or leather treatments directly inside the CRM dashboard.",
  },
  {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-slate-600 text-sm md:text-base leading-relaxed">
              Do not miss potential business. Separate from your active customer database, the CRM Leads module helps your sales team record custom detailing quotes, walk-in leads, and conversions.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex justify-between text-xs border-b border-slate-200/40 pb-2">
                <div>
                  ...
                  <span className="text-[10px] text-slate-400">Enquiry: PPF Wrap (Matte)</span>
                </div>
                <span className="text-amber-600 font-bold">In Progress</span>
              </div>
              <div className="flex justify-between text-xs border-b border-slate-200/40 pb-2">
                <div>
                  <span className="font-bold text-slate-700 block">Naman Motors</span>
                  <span className="text-[10px] text-slate-400">Enquiry: 5x Ceramic Coating</span>
                </div>
                <span className="text-emerald-600 font-bold">Converted</span>
              </div>
              <div className="flex justify-between text-xs">
                <div>
                  <span className="font-bold text-slate-700 block">Ravi Patel</span>
                  <span className="text-[10px] text-slate-400">Enquiry: Interior Detailing</span>
                </div>
