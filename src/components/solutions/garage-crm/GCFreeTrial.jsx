    ...
    <section className="py-20 px-4 lg:px-15 2xl:px-50 bg-white flex justify-center border-b border-slate-200/60">
      <div className="mx-auto max-w-full lg:max-w-6xl w-full text-center">
        ...
        <h2 className="text-2xl md:text-4xl font-bold text-text-dark mt-4 mb-6 leading-tight">
          Try GarageSaarthi CRM with <GradientUnderline>a 7-Day Free Trial</GradientUnderline>
        </h2>
        <p className="text-slate-600 text-sm md:text-base leading-relaxed mb-8 max-w-xl mx-auto">
          Explore complete access to our cloud dashboard, Android application, customer lists, CRM lead logs, and follow-up calendars. Billed in affordable INR plans. No credit card required.
        </p>
