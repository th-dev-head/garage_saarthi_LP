        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-300 text-sm md:text-base max-w-xl leading-relaxed">
              Manage digital job cards, customer details, vehicle records, parts inventory, mechanic tasks, billing, and automated service alerts right from your smartphone.
            </p>
...
<Link
              ...
              <Link
                href="https://platform.garagesaarthi.com/"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl w-full max-w-[340px] lg:max-w-md">
              ...
              <div className="space-y-4">
                <div className="bg-white/5 p-4 rounded-xl border border-white/5">
                  ...
                  <span className="text-lg font-bold text-white">₹24,800</span>
                </div>
                <div className="bg-white/5 p-4 rounded-xl border border-white/5">
                  <span className="text-[10px] text-slate-400 block mb-0.5">ACTIVE JOB CARDS</span>
                  <span className="text-lg font-bold text-white">12 Vehicles</span>
                </div>
              </div>
            </div>
          </div>
