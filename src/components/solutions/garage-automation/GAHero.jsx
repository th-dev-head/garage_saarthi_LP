      ...
      <div className="mx-auto max-w-full lg:max-w-3xl w-full relative z-10 text-center flex flex-col items-center">
        <div className="flex flex-col items-center text-center max-w-3xl">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight">
            Garage Automation Software for <GradientUnderline>Smarter Workshop Operations</GradientUnderline>
          </h1>
          <p className="text-slate-300 text-sm md:text-base leading-relaxed mb-8 max-w-2xl mx-auto">
            Digitize job cards, automate GST billing, manage spare parts inventory, and organize customer service reminders in a unified dashboard. Stop relying on manual paper files.
          </p>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-center items-center w-full sm:w-auto">
            ...
            <Link
              href="#garage-automation-workflow"
