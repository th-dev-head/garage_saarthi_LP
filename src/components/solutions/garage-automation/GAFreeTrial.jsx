...
export default function GAFreeTrial() {
    ...
    <section className="py-20 px-4 lg:px-15 2xl:px-50 bg-white flex justify-center">
      <div className="mx-auto max-w-full lg:max-w-4xl w-full text-center space-y-6">
        <h2 className="text-2xl md:text-4xl font-bold text-text-dark leading-tight">
          Start Automating Your Garage with a <GradientUnderline>7-Day Free Trial</GradientUnderline>
        </h2>
        <p className="text-slate-600 text-sm md:text-base leading-relaxed max-w-2xl mx-auto">
          Start using GarageSaarthi's <strong className="text-primary capitalize">garage automation software</strong> features today. 
          Manage digital job cards, track spares inventory, generate GST invoices, and configure WhatsApp reminders.
        </p>
