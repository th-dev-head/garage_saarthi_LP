...
const differentiators = [
  ...
  "Supports custom preventative and scheduled maintenance checklists",
  "Creates digital job cards with complaints, estimate, and parts allocation",
  "Maintains complete passenger bus and cargo vehicle history logs",
...
export default function FLWhyUs() {
  return (
      ...
      <div className="mx-auto max-w-full lg:max-w-6xl 2xl:max-w-full w-full">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-2xl md:text-4xl font-bold text-text-dark mt-4 mb-6 leading-tight">
            Why Fleet Workshop Owners{" "}
            <GradientUnderline>Use GarageSaarthi</GradientUnderline>
          </h2>
          <p className="text-slate-600 text-sm md:text-base leading-relaxed">
            Automotive repair shops need tools tailored to service checklists, mechanics, and parts stock. Here is why transport fleet workshops choose GarageSaarthi.
          </p>
        </div>
