...
const reviews = [
  {
    ...
    initials: "SK",
    text: "Automated service reminders send WhatsApp notifications to clients, bringing them back precisely on schedule. It has significantly improved our repeat business count."
  },
  {
    name: "Gurpreet Singh",
...
export default function GSITestimonials() {
  return (
    <TestimonialsGrid
      title="What Workshop Owners in India Say About"
      titleHighlight="GarageSaarthi"
