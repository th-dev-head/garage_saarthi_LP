...
const alertPoints = [
  {
    title: "Track Upcoming Service Follow-Ups",
  ...
  },
  {
    ...
    desc: "Send polite, automated WhatsApp reminders containing the bike model and service due details directly to your customers, encouraging repeat visits.",
  },
  {
    title: "Send Special Offers and Promotions",
    desc: "Promote seasonal bike checkups, monsoon service camps, or special engine oil deals to inactive customer lists to bring them back to your garage.",
  },
];

export default function BWServiceAlerts() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 bg-slate-50 border border-slate-200/80 rounded-3xl p-6 md:p-8 shadow-sm">
            ...
            <div className="bg-white border border-slate-200/40 rounded-2xl p-4 shadow-xs space-y-2">
              <div className="flex justify-between items-center border-b border-slate-100 pb-2">
                <span className="text-[10px] font-bold text-slate-800">To: Amit Sharma</span>
                <span className="text-[9px] text-slate-400">Scheduled: 10:00 AM</span>
              </div>
              <p className="text-[11px] text-slate-600 leading-relaxed italic">
                "Hello Amit, your Honda Activa (GJ-05-XX-1234) is due for its periodic service on 25th July. Book your slot today at Ever Garage for a smooth ride! - Powered by GarageSaarthi"
              </p>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h2 className="text-2xl md:text-4xl font-bold text-text-dark mt-4 mb-4 leading-tight">
              Bring Bike Customers Back with <GradientUnderline>Timely Service Alerts</GradientUnderline>
            </h2>
