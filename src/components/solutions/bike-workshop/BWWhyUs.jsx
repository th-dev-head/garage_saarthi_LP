...
const differentiators = [
  "Built specifically for automotive and two-wheeler workshop operations",
  "Supports customized bike and scooter service workflows",
...
export default function BWWhyUs() {
  return (
      ...
      <div className="mx-auto max-w-full lg:max-w-6xl 2xl:max-w-full w-full">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-2xl md:text-4xl font-bold text-text-dark mt-4 mb-6 leading-tight">
            Why Bike Workshop Owners{" "}
            <GradientUnderline>Use GarageSaarthi</GradientUnderline>
          </h2>
          <p className="text-slate-600 text-sm md:text-base leading-relaxed">
            Automotive repair shops need tools tailored to service checklists, mechanics, and parts stock. Here is why independent garages choose GarageSaarthi.
          </p>
        </div>
