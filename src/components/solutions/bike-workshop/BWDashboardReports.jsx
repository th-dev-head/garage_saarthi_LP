...
export default function BWDashboardReports() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h2 className="text-2xl md:text-4xl font-bold text-text-dark mt-4 mb-4 leading-tight">
              Understand Your Bike Workshop with{" "}
              <GradientUnderline>Dashboard and Reports</GradientUnderline>
            </h2>
            <p className="text-slate-600 text-sm md:text-base leading-relaxed">
              Ditch the guesswork. View clear reports on how your service center is performing. Audit parts stock, see mechanic collections, and view payments received in a few clicks.
            </p>
          ...
          <div className="lg:col-span-5 bg-slate-50 border border-slate-200/80 rounded-3xl p-6 md:p-8 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-white border border-slate-200/40 p-4 rounded-2xl shadow-xs">
                ...
                <p className="text-lg font-bold text-primary mt-1">₹8,450</p>
              </div>
              <div className="bg-white border border-slate-200/40 p-4 rounded-2xl shadow-xs">
                <span className="text-[10px] text-slate-400 font-bold uppercase">Completed Cards</span>
                <p className="text-lg font-bold text-slate-800 mt-1">112</p>
              </div>
              <div className="bg-white border border-slate-200/40 p-4 rounded-2xl shadow-xs">
                <span className="text-[10px] text-slate-400 font-bold uppercase">Low Stock Alerts</span>
                <p className="text-lg font-bold text-red-600 mt-1">4</p>
              </div>
            </div>
          </div>
        </div>
