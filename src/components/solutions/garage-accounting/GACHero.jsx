      ...
      <div className="mx-auto max-w-full lg:max-w-5xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        <div className="lg:col-span-7 text-center lg:text-left flex flex-col items-center lg:items-start">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight">
            Garage Accounting Software Built for Automotive Workshops
          </h1>
          <p className="text-slate-300 text-sm md:text-base leading-relaxed mb-8 max-w-2xl">
            Manage workshop payments, expenses, financial records, GST billing, and loans. Provide your Chartered Accountant (CA) read-only access to relevant records easily.
          </p>
        ...
        <div className="lg:col-span-5 flex justify-center">
          <div className="bg-slate-800/80 border border-slate-700/50 rounded-3xl p-6 shadow-2xl w-full max-w-md relative overflow-hidden backdrop-blur-sm">
            <div className="flex items-center justify-between border-b border-slate-700/50 pb-4 mb-4">
              <span className="text-xs font-bold text-slate-400">Accounting Ledger</span>
              <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse" />
            </div>
            <div className="space-y-4">
              <div className="bg-slate-900/50 rounded-2xl p-4 border border-slate-700/30">
                <p className="text-xs text-slate-400">Total Accounts Receivable</p>
                <p className="text-2xl font-bold text-emerald-400 mt-1">₹3,45,800</p>
              </div>
              <div className="bg-slate-900/50 rounded-2xl p-4 border border-slate-700/30">
                <p className="text-xs text-slate-400">Accounts Payable</p>
                <p className="text-2xl font-bold text-rose-400 mt-1">₹68,450</p>
              </div>
            </div>
          </div>
        </div>
