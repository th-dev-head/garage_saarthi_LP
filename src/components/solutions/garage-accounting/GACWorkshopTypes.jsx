...
export default function GACWorkshopTypes() {
  ...
  const types = [
    ...
    { title: "EV Garage Finance Management", desc: "Track battery repair service records, specialized EV part entries, and specific tech payroll logs.", url: "/solutions/ev-garage-software" },
      ...
      <div className="mx-auto max-w-full lg:max-w-6xl w-full space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h2 className="text-2xl md:text-4xl font-bold text-text-dark leading-tight">
            Garage Accounting Software for <GradientUnderline>Different Automotive Businesses</GradientUnderline>
          </h2>
          <p className="text-slate-600 text-sm md:text-base leading-relaxed">
            Our software satisfies the unique requirements of different automotive repair models. Avoid generic accounting setups.
          </p>
        </div>
