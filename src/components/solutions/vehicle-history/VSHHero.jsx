...
export default function VSHHero() {
  ...
  const handleFeatureClick = () => {
    trackEvent("vehicle_management_click", {
      page_path: "/solutions/vehicle-service-history-software/",
      cta_location: "hero",
      cta_label: "Explore Vehicle Management",
    ...
    <section className="relative pt-48 pb-24 md:pt-45 md:pb-32 px-4 lg:px-15 2xl:px-50 bg-gradient-to-br from-slate-900 via-slate-800 to-orange-950 text-white overflow-hidden flex justify-center">
      ...
      <div className="mx-auto max-w-full lg:max-w-5xl w-full relative z-10 text-center flex flex-col items-center">
        ...
        <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight">
          Vehicle Service History Software for Garages and Workshops
        </h1>
        <p className="text-slate-300 text-sm md:text-base leading-relaxed mb-8 max-w-2xl mx-auto">
          Keep vehicle service, repair, and maintenance records organized digitally. Access customer vehicle histories and past workshop job details in one secure place.
        </p>
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-center items-center w-full sm:w-auto">
          ...
          <Link href="/features/vehicles/" onClick={handleFeatureClick} className="rounded-full border border-white/30 bg-white/5 hover:bg-white/10 text-white px-8 py-3 text-sm font-semibold transition-all duration-200 flex items-center justify-center cursor-pointer w-full sm:w-auto whitespace-nowrap h-11 text-center">
