...
export default function GGPFreeTrial() {
  const handleTrialClick = () => {
    trackEvent("gate_pass_trial_cta_click", {
  ...
  const handlePricingClick = () => {
    trackEvent("gate_pass_pricing_click", {
      page_path: "/solutions/garage-gate-pass-software/",
      cta_location: "pricing_section",
    ...
    <section className="py-20 px-4 lg:px-15 2xl:px-50 bg-slate-50 flex justify-center">
      <div className="mx-auto max-w-full lg:max-w-6xl 2xl:max-w-full w-full text-center">
        ...
        <p className="text-slate-600 text-sm md:text-base leading-relaxed mb-8 max-w-xl mx-auto">
          Explore complete access to our QR gate pass engine, zero-login guard verification, thermal slip printing, and cloud exit ledger. No credit card required.
        </p>
