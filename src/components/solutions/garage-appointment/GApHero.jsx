...
export default function GApHero() {
  const handleTrialClick = () => {
    trackEvent("trial_cta_click", {
      page_path: "/solutions/garage-appointment-software/",
      page_name: "garage_appointment_software",
      cta_location: "hero",
      ...
      <div className="mx-auto max-w-full lg:max-w-5xl w-full relative z-10 text-center flex flex-col items-center">
        <div className="flex flex-col items-center text-center max-w-5xl">
          <span className="text-xs uppercase tracking-widest bg-orange-600/30 text-orange-400 px-3 py-1.5 rounded-full border border-orange-500/20 font-semibold mb-6 inline-block">
            Appointment & Pickup-Drop Logistics
          </span>
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight">
            Garage Appointment Software to <GradientUnderline>Streamline Bookings</GradientUnderline> & Doorstep Pickups
          </h1>
          <p className="text-slate-300 text-sm md:text-base leading-relaxed mb-8 max-w-2xl mx-auto">
            Organize service slot scheduling, driver Google Maps navigation, doorstep vehicle delivery, and WhatsApp confirmations. Built specifically for automotive garages, car workshops, and bike service centers in India.
          </p>
