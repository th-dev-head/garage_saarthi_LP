...
export default function GICFreeTrial() {
  const handleTrialClick = () => {
    trackEvent("insurance_trial_cta_click", {
  ...
  const handlePricingClick = () => {
    trackEvent("insurance_pricing_click", {
      page_path: "/solutions/garage-insurance-claim-software/",
      cta_location: "pricing_section",
    ...
    <section className="py-20 px-4 lg:px-15 2xl:px-50 bg-white flex justify-center">
      <div className="mx-auto max-w-full lg:max-w-6xl 2xl:max-w-full w-full text-center">
        ...
        <p className="text-slate-600 text-sm md:text-base leading-relaxed mb-8 max-w-xl mx-auto">
          Explore complete access to our insurance claim calculator, surveyor dossier manager, depreciation matrix, and cashless payment tracker. No credit card required.
        </p>
