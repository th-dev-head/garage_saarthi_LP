        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-300 text-sm md:text-base max-w-xl leading-relaxed">
              Track vehicle details, diagnostics logs, service histories, and Odometer/KM readings in real-time. Link every vehicle to its owner profile for seamless check-ins and precision servicing.
            </p>
          ...
          <div className="flex justify-center md:justify-end w-full">
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl w-full max-w-[340px] lg:max-w-md">
              <div className="flex justify-between items-center pb-4 mb-4 border-b border-white/10">
                <span className="text-xs font-bold text-white">Vehicle Record Card</span>
                <span className="text-[10px] text-green-400 bg-green-500/10 px-2 py-0.5 rounded font-semibold">MH-12-AB-1234</span>
              </div>
              <div className="space-y-4">
                <div className="bg-white/5 p-4 rounded-xl border border-white/5 space-y-1">
                  <span className="text-[10px] text-slate-400 block">VEHICLE DETAILS</span>
                  <span className="text-sm font-bold text-white block">Maruti Suzuki Swift (VXI)</span>
                  <span className="text-xs text-slate-300 block">Chassis: MA3EY2... | KM: 42,500</span>
                </div>
                ...
                <div className="bg-white/5 p-4 rounded-xl border border-white/5 flex justify-between items-center">
                  ...
                  <span className="text-xs font-bold text-amber-400">12 Days Ago</span>
                </div>
              </div>
            </div>
          </div>
