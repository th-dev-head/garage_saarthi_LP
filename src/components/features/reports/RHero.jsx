...
const rHeroBlocks = [
  { label: "MONTHLY WORKSHOP REVENUE", title: "₹3,45,000 Total Sales", titleClass: "text-xs font-bold text-emerald-400 block" },
  { label: "SPARE PARTS MARGIN ANALYSIS", title: "₹92,400 Gross Profit (26.8%)", titleClass: "text-xs font-bold text-amber-400 block" },
  { label: "MECHANIC EFFICIENCY RATING", title: "94.2% On-Time Service Completion", titleClass: "text-xs text-blue-400 font-semibold block" }
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-300 text-sm md:text-base max-w-xl leading-relaxed">
              Transform workshop data into actionable business decisions. Track daily revenue trends, spare parts turnover, technician productivity, and profit margins with 1-click PDF/Excel report exports.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl w-full max-w-[340px] lg:max-w-md">
              <div className="flex justify-between items-center pb-4 mb-4 border-b border-white/10">
                <span className="text-xs font-bold text-white flex items-center gap-1.5">
                  <FaChartLine className="text-amber-400 w-4 h-4" /> Real-Time Analytics
                </span>
                <span className="text-[10px] text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded font-semibold">Automated Sync</span>
              </div>
              <div className="space-y-4">
                {rHeroBlocks.map((block, idx) => (
