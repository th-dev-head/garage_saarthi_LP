...
export default function BInventorySync() {
  return (
      ...
      <div className="mx-auto max-w-full lg:max-w-6xl 2xl:max-w-full w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="bg-white border border-slate-200/80 p-8 rounded-3xl space-y-4 shadow-sm">
          <div className="flex items-center gap-2 border-b border-slate-100 pb-4">
            ...
            <h3 className="text-sm font-bold text-slate-900 uppercase tracking-wide">Live Stock Adjustments</h3>
          </div>
          <div className="space-y-3.5 text-xs text-slate-600">
            <div className="bg-slate-50 p-4 rounded-xl flex justify-between items-center font-bold">
              ...
              <span className="text-red-600 font-bold bg-red-50 px-2.5 py-1 rounded">-1 in Parts Stock</span>
            </div>
            <div className="bg-slate-50 p-4 rounded-xl flex justify-between items-center font-bold">
              <span>Auto-Populated on Invoice</span>
              <span className="text-green-600 font-bold bg-green-50 px-2.5 py-1 rounded">Ready to Bill (₹1,850)</span>
            </div>
          </div>
        </div>
      </div>
