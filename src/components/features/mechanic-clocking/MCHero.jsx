...
import { FaArrowRight, FaStopwatch, FaUserCheck, FaCheckCircle, FaWrench, FaChartLine } from "react-icons/fa";
...
export default function MCHero() {
  const handleTrialClick = () => {
    trackEvent("mechanic_clocking_feature_trial_cta_click", {
      page_path: "/features/mechanic-clocking/",
      cta_location: "hero",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-300 text-sm md:text-base max-w-xl leading-relaxed">
              Track exactly how much time mechanics spend on every job card service. Compare estimated standard hours against actual bay time, log parts-waiting pauses, eliminate idle bay wastage, and reward top technicians accurately.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl w-full max-w-[340px] lg:max-w-md">
              <div className="flex justify-between items-center pb-4 mb-4 border-b border-white/10">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-white">Live Bay #2 &bull; Active Task</span>
                </div>
                <span className="text-[10px] text-emerald-400 bg-emerald-500/10 px-2.5 py-1 rounded font-mono font-bold border border-emerald-500/20">
                  01:24:18
                </span>
              </div>
              <div className="space-y-4">
                <div className="bg-white/5 p-4 rounded-xl border border-white/5">
                  <div className="flex justify-between items-start">
                    <div>
                      <span className="text-[10px] text-slate-400 block mb-0.5">JOB CARD #JC-2026-9041</span>
                  ...
                  <span className="text-[11px] text-amber-300 font-semibold block mt-1">
                    Task: Front Brake Overhaul &amp; Disc Skimming
                  </span>
                </div>

                <div className="bg-white/5 p-4 rounded-xl border border-white/5 flex justify-between items-center">
                  <div>
                    <span className="text-[10px] text-slate-400 block">ASSIGNED MECHANIC</span>
                    <span className="text-xs font-bold text-white">Ramesh Sharma</span>
                    <span className="text-[10px] text-slate-400">Senior Technician (Bay 2)</span>
                  </div>
                ...
                <div className="bg-white/5 p-3.5 rounded-xl border border-white/5 grid grid-cols-2 gap-3 text-xs">
                  <div>
                    <span className="text-[10px] text-slate-400 block">Est. Time</span>
                    <span className="text-xs font-bold text-white">1 hr 30 min</span>
                  </div>
                  <div>
                    <span className="text-[10px] text-slate-400 block">Breaks / Pauses</span>
                    <span className="text-xs font-bold text-amber-400">8 min (Parts Wait)</span>
                  </div>
                </div>
              </div>
            </div>
