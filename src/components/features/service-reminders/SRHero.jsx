...
const srHeroBlocks = [
  { label: "CUSTOMER & VEHICLE", title: "Ramesh Patel • Honda City", sub: "GJ 05 CD 5678 (45,000 KM)" },
  { label: "REMINDER TYPE", title: "6-Month Periodic Oil & Filter Service Due", titleClass: "text-xs font-bold text-amber-400 block" },
  { label: "AUTOMATED ACTION", title: "WhatsApp Alert Sent with Booking Link ✅", titleClass: "text-xs text-emerald-400 font-semibold block" }
];

export default function SRHero() {
  const handleTrialClick = () => {
    trackEvent("service_reminder_feature_trial_cta_click", {
      page_path: "/features/service-reminders",
      cta_location: "hero",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-300 text-sm md:text-base max-w-xl leading-relaxed">
              Never let a customer forget their periodic vehicle maintenance. Automatically send timely service due alerts, inspection reminders, and insurance expiry notifications directly to WhatsApp.
            </p>
          ...
          <div className="flex justify-center md:justify-end w-full">
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl w-full max-w-[340px] lg:max-w-md">
              <div className="flex justify-between items-center pb-4 mb-4 border-b border-white/10">
                <span className="text-xs font-bold text-white">Live Service Due Alert #SR-3012</span>
                <span className="text-[10px] text-green-400 bg-green-500/10 px-2 py-0.5 rounded font-semibold">Auto Sent</span>
              </div>
              <div className="space-y-4">
                {srHeroBlocks.map((block, idx) => (
