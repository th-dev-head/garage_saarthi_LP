...
export default function SRFinalCTA() {
  const handleCtaClick = () => {
    trackEvent("service_reminder_feature_final_cta_click", {
    ...
    <section className="py-20 px-4 lg:px-15 2xl:px-50 bg-gradient-to-br from-slate-900 via-slate-800 to-orange-950 text-white text-center relative overflow-hidden flex justify-center">
      ...
      <div className="mx-auto max-w-full lg:max-w-4xl relative z-10 space-y-6">
        ...
        <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight leading-tight">
          Ready to Automate Your Garage Service Reminders?
        </h2>
        <p className="text-slate-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
          Join thousands of workshops boosting repeat visits and customer satisfaction with GarageSaarthi automated WhatsApp service alerts.
        </p>
