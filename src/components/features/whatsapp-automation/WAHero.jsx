...
const waHeroBlocks = [
  { label: "CUSTOMER & VEHICLE", title: "Vijay Sharma • Hyundai Creta", sub: "GJ 01 AB 1234" },
  { label: "AUTOMATED NOTIFICATION", title: "Job Card Estimate & Digital PDF Sent 📄", titleClass: "text-xs font-bold text-emerald-400 block" },
  { label: "CUSTOMER ACTION", title: "Estimate Approved via WhatsApp ✅", titleClass: "text-xs text-amber-400 font-semibold block" }
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-300 text-sm md:text-base max-w-xl leading-relaxed">
              Send job card estimates, digital PDF invoices, service due reminders, and online payment UPI links directly to your customer's WhatsApp inbox in one click.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl w-full max-w-[340px] lg:max-w-md">
              <div className="flex justify-between items-center pb-4 mb-4 border-b border-white/10">
                <span className="text-xs font-bold text-white flex items-center gap-1.5">
                  <FaWhatsapp className="text-emerald-400 w-4 h-4" /> Live WhatsApp Update
                </span>
                <span className="text-[10px] text-green-400 bg-green-500/10 px-2 py-0.5 rounded font-semibold">Delivered</span>
              </div>
              <div className="space-y-4">
                {waHeroBlocks.map((block, idx) => (
