...
const crHeroBlocks = [
  { label: "CUSTOMER & VEHICLE", title: "Anil Kapoor • Mahindra Thar", sub: "GJ 01 XX 7777" },
  { label: "AUTOMATED FEEDBACK LINK", title: "WhatsApp 5-Star Review Prompt Sent ⭐", titleClass: "text-xs font-bold text-amber-400 block" },
  { label: "GOOGLE RATING RESULT", title: "5.0 ★ Rating Posted on Google Profile ✅", titleClass: "text-xs text-emerald-400 font-semibold block" }
];

export default function CRHero() {
  const handleTrialClick = () => {
    trackEvent("customer_reviews_feature_trial_cta_click", {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight leading-tight">
              Automated Google 5-Star Reviews &{" "}
              <span className="relative inline-block">
                Garage Rating Booster
            ...
            <p className="text-slate-300 text-sm md:text-base max-w-xl leading-relaxed">
              Turn happy car and bike owners into 5-star Google reviews automatically. Send automated WhatsApp feedback links after invoice generation and rank #1 in local workshop searches.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl w-full max-w-[340px] lg:max-w-md">
              <div className="flex justify-between items-center pb-4 mb-4 border-b border-white/10">
                <span className="text-xs font-bold text-white flex items-center gap-1">
                  <FaStar className="text-amber-400 w-4 h-4" /> Live Review Request
                </span>
                <span className="text-[10px] text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded font-semibold">Automated</span>
              </div>
              <div className="space-y-4">
                {crHeroBlocks.map((block, idx) => (
