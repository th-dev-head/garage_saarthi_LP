...
export default function WMDHero() {
  const handleTrialClick = () => {
    trackEvent("dashboard_feature_trial_cta_click", {
      page_path: "/features/workshop-management-dashboard",
      cta_location: "hero",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight leading-tight">
              Centralized Workshop Dashboard &{" "}
              <span className="relative inline-block">
                Garage Analytics Software
            ...
            <p className="text-slate-300 text-sm md:text-base max-w-xl leading-relaxed">
              Track live job cards, daily revenue collections, mechanic efficiency KPIs, and spare parts stock levels from a single real-time dashboard screen. Empower your garage operations with 100% cloud visibility.
            </p>
          ...
          <div className="flex justify-center md:justify-end w-full">
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl w-full max-w-[340px] lg:max-w-md">
              <div className="flex justify-between items-center pb-4 mb-4 border-b border-white/10">
                <span className="text-xs font-bold text-white">Live Workshop Analytics</span>
