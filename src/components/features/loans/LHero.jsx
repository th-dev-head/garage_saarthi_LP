...
const lHeroBlocks = [
  { label: "BUSINESS & EQUIPMENT LOANS", title: "₹5,00,000 Equipment Financing", sub: "Bank of Baroda • Active" },
  { label: "UPCOMING EMI DUE DATE", title: "₹18,500 EMI Due on 5th August", titleClass: "text-xs font-bold text-amber-400 block" },
  { label: "REPAYMENT STATUS", title: "Automated Bank Mandate Active ✅", titleClass: "text-xs text-emerald-400 font-semibold block" }
];

export default function LHero() {
  const handleTrialClick = () => {
    trackEvent("loan_management_feature_trial_cta_click", {
      page_path: "/features/loans",
      cta_location: "hero",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-300 text-sm md:text-base max-w-xl leading-relaxed">
              Track business loans, workshop hydraulic lift equipment financing, working capital debts, EMI installment schedules, and interest expenses in one unified dashboard.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl w-full max-w-[340px] lg:max-w-md">
              <div className="flex justify-between items-center pb-4 mb-4 border-b border-white/10">
                <span className="text-xs font-bold text-white flex items-center gap-1.5">
                  <FaCalculator className="text-amber-400 w-4 h-4" /> EMI Repayment Tracker
                </span>
                <span className="text-[10px] text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded font-semibold">Active Loans</span>
              </div>
              <div className="space-y-4">
                {lHeroBlocks.map((block, idx) => (
