    ...
    <footer className="relative px-4 lg:px-15 2xl:px-50 py-12 bg-white overflow-hidden border-t border-gray-200/60">
      ...
      <div className="mx-auto max-w-full lg:max-w-6xl relative z-10">
        ...
        <div className="pt-6 border-t border-gray-200/60 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm 2xl:text-sm text-slate-600">
            ...
            {SOCIAL_LINKS.map((link) => {
              ...
              return (
                <Link
                  ...
                  className="w-8 h-8 rounded-full border border-gray-100 bg-orange-50 flex items-center justify-center hover:bg-[#B02E0C] hover:border-[#B02E0C] group transition-all"
                >
