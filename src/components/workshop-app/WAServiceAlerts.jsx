...
export default function WAServiceAlerts() {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="text-2xl md:text-4xl font-bold text-text-dark mt-4 mb-4 leading-tight">
              ...
              <span className="relative inline-block">
                Customer Follow-Ups from the App
          ...
          <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-6 shadow-sm w-full max-w-md mx-auto md:max-w-none md:order-last order-first">
            <h4 className="text-xs font-bold text-slate-900 mb-4 flex items-center gap-2">
              ...
              WhatsApp Reminders Preview
            </h4>
            <div className="text-xs text-slate-700 bg-white p-4 rounded-xl border-l-4 border-primary font-sans shadow-xs">
