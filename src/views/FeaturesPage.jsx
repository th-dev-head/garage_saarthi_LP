...
const allFeaturesList = [
  {
    ...
    items: [
      ...
      { title: "Team Chat & @Mentions", description: "Internal job card discussion thread with staff @mentions and live activity logs.", icon: WhatsAppIcon, href: "/features/job-card-management/" },
